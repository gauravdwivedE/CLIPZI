...
const ThemeToggle = () => {
  ...
  return (
    <div
      className={`fixed top-1/2 -translate-y-1/2 -right-22 sm:-right-17 flex items-center gap-2 ${
        theme === 'light' ? 'bg-gray-200' : 'bg-[#181E29]'
      } border-[1px] border-[#353C4A] rotate-90 justify-between rounded-full shadow-lg p-1 h-11 w-58`}
    >
      <button
