    ...
    <>
      <div className="w-full overflow-x-auto text-[#C9CED6] mt-15 transition-all duration-1000">
        ...
        {loading ? <Loader2 /> :<div className="flex justify-center min-w-max">
          {shortened.length > 0 ? (
            <table className=" transition-all w-[78rem] rounded-xl overflow-hidden border-separate border-spacing-y-[3px]">
              <tr
                className={`${
                  theme === "light"
                  ...
                  >
                    <td className="whitespace-nowrap text-[13px] py-2 pl-4 flex gap-3 items-center">
                      ...
                      <span
                        ...
                        className={`w-8 h-8 rounded-full flex justify-center items-center ${theme === 'light' ? 'bg-gray-300' : 'bg-[#1C283FB0] '}  cursor-pointer`}
                      >
                        <FaCopy />
                      </span>
                    </td>
                      ...
                      {item.qrImage ? (
                        <>
                          ...
                          <span
                            ...
                            className={`w-8 h-8 rounded-full flex justify-center items-center ${theme === 'light' ? 'bg-gray-300': 'bg-[#1C283FB0]'}`}
                          >
                            <MdOutlineFileDownload />
                          </span>
                        </>
